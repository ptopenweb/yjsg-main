...
$yjsg_js.="
			...
			lgtr.yjsgplg_error_notconnected='".JText::_('YJSG_YJSGPLG_ERROR_NOTCONNECTED')."';	
			lgtr.yjsgplg_error_notfound='".JText::_('YJSG_YJSGPLG_ERROR_NOTFOUND')."';	
			lgtr.yjsgplg_error_server='".JText::_('YJSG_YJSGPLG_ERROR_SERVER')."';	
			lgtr.yjsgplg_error_parsefailed='".JText::_('YJSG_YJSGPLG_ERROR_PARSEFAILED')."';	
