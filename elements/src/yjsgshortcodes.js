...
(function ($) {
    ...
    var YjsgShortcodes = {
		...
		var MediaShortcode = '<a class="btn yjsg-shortcode-link"';
			...
			MediaShortcode += lgtr.yjsgshortcodes_media;
			MediaShortcode += ' </a>';
		...
		var NotificationsShortcode = '<a class="btn yjsg-shortcode-link"';
			...
			NotificationsShortcode += lgtr.yjsgshortcodes_notifications;	
		...
		var IconsShortcode = '<a class="btn yjsg-shortcode-link"';
			...
			IconsShortcode += lgtr.yjsgshortcodes_icons;	
			IconsShortcode += ' </a>';	
		...
		var AccordionShortcode = '<a class="btn yjsg-shortcode-link"';
			...
			AccordionShortcode += lgtr.yjsgshortcodes_acoordion;
		...
		var TabsShortcode = '<a class="btn yjsg-shortcode-link"';
			...
			TabsShortcode += lgtr.yjsgshortcodes_tabs;
			TabsShortcode += ' </a>';	
		...
		var ImagesShortcode = '<a class="btn yjsg-shortcode-link"';
			...
			ImagesShortcode += lgtr.yjsgshortcodes_images;
			ImagesShortcode += ' </a>';			
